...
0. General Questions
    ...
    b. All enum-style values are strings. Can these be enumerated, or is there no consistency among hospitals. Can such fields be mapped to FHIR fields which do have defined values? What about case sensitivity?
