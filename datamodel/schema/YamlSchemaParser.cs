...
namespace datamodel.schema {
    ...
    internal class YamlSchemaParser {
        public List<Table> Parse(string path, List<Error> errors) {
            List<Association> allAssociations = new List<Association>();
            List<Table> tables = new List<Table>();

            YamlDocument document = YamlUtils.ReadYaml(path);

            foreach (YamlMappingNode tableData in document.RootNode as YamlSequenceNode) {
                Table table = new Table() {
                    ClassName = YamlUtils.GetString(tableData, "name"),
                ...
                foreach (YamlMappingNode assocData in associations)
                    allAssociations.Add(Association.Parse(table, assocData));
    ...
    class Association {
        ...
        internal static Association Parse(Table table, YamlMappingNode assocData) {
